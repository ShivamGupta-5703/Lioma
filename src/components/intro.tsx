...
import Lungs from "@/assets/Mainbackground.png"
    ...
    <section className="py-4 md:py-0 min-h-screen grid md:grid-cols-2 place-items-center">
      <div className="w-11/12 md:w-1/2 flex flex-col items-center text-center">
        ...
        <p className="text-center text-sm md:text-base mt-6">
          Your digital gateway to the botanical world. Unearth a wealth of insights, from lung details to disease detection, effortlessly bridging the gap between technology and the beauty of lungs.
        </p>
        <Button className="my-7" asChild>
          <Link href="/home">Use Lioma</Link>
        </Button>
      </div>
