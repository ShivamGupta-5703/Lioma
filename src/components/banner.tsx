    ...
    return (
        <div className='border-t border-b border-[#000] py-10'>
            ...
            <div className="w-full text-center pt-1">
                <h3 className="uppercase bg-[#A09EFF] rounded p-2 text-xl md:text-2xl text-center inline-block font-medium z-20 relative">
                    POWERING LUNGS WITH THE TOP ADVICES
                </h3>
            </div>
